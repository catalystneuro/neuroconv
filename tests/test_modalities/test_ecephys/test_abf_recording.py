...
class TestAbfRecordingInterface(unittest.TestCase):
    ...
    def test_extractor_name(self):
        ...
        from neuroconv.datainterfaces.ecephys.abf.abfrecordinginterface import (
            _AbfRecordingExtractor,
        )
    ...
    def test_source_data_to_extractor_kwargs(self):
        ...
        source_data = {"file_path": "test.abf", "stream_id": "stream1", "verbose": True}
