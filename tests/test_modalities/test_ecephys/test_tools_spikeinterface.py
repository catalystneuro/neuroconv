...
class TestAddElectrodes(TestCase):
    ...
    def test_default_electrode_column_names(self):
        __add_electrodes_to_nwbfile(recording=self.base_recording, nwbfile=self.nwbfile)
    ...
    def test_integer_channel_names(self):
        ...
        __add_electrodes_to_nwbfile(recording=self.base_recording, nwbfile=self.nwbfile)
        __add_electrodes_to_nwbfile(recording=recorder_with_offset_channels, nwbfile=self.nwbfile)
    ...
    def test_string_channel_names(self):
        ...
        __add_electrodes_to_nwbfile(recording=self.recording_1, nwbfile=self.nwbfile)
        __add_electrodes_to_nwbfile(recording=self.recording_2, nwbfile=self.nwbfile)
    ...
    def test_non_overwriting_channel_names_property(self):
        "_add_electrodes_to_nwbfile function should not overwrite the recording object channel name property"
    ...
    def test_channel_group_names_table(self):
        "_add_electrodes_to_nwbfile function should add new rows if same channel names, but different group_names"
        __add_electrodes_to_nwbfile(recording=self.recording_1, nwbfile=self.nwbfile)
    ...
    def test_manual_row_adition_before_add_electrodes_function_to_nwbfile(self):
        """Add some rows to the electrode tables before using the _add_electrodes_to_nwbfile function"""
    ...
    def test_manual_row_adition_after_add_electrodes_function_to_nwbfile(self):
        """Add some rows to the electrode table after using the _add_electrodes_to_nwbfile function"""
        __add_electrodes_to_nwbfile(recording=self.recording_1, nwbfile=self.nwbfile)
    ...
    def test_manual_row_adition_before_add_electrodes_function_optional_columns_to_nwbfile(self):
        """Add some rows including optional columns to the electrode tables before using the _add_electrodes_to_nwbfile function."""
    ...
    def test_no_new_electrodes_with_custom_property_without_default(self):
        """
        Test that _add_electrodes_to_nwbfile doesn't fail when:
    ...
    def test_adding_new_property_with_identifical_channels_but_different_groups(self):
        ...
        __add_electrodes_to_nwbfile(recording=recording1, nwbfile=self.nwbfile)
        __add_electrodes_to_nwbfile(recording=recording2, nwbfile=self.nwbfile)
    ...
    def test_property_metadata_mismatch(self):
        ...
        __add_electrodes_to_nwbfile(recording=self.recording_1, nwbfile=self.nwbfile, metadata=metadata)
        __add_electrodes_to_nwbfile(recording=self.recording_2, nwbfile=self.nwbfile, metadata=metadata)
    ...
    def test_electrode_name_column_added_with_probe(self):
        ...
        __add_electrodes_to_nwbfile(recording=recording, nwbfile=self.nwbfile)
    ...
    def test_electrode_table_with_probe_and_multiple_recordings(self):
        ...
        __add_electrodes_to_nwbfile(recording=recording3, nwbfile=self.nwbfile)
