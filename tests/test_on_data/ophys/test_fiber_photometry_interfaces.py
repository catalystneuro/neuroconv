...
class TestGuppyFiberPhotometryInterface:
    """Tests for the GuppyFiberPhotometryInterface against the standard GuPPy fixture set."""
    ...
    def case(self, request):
        ...
        assert case["folder_path"].is_dir(), (
            f"Test data missing at {case['folder_path']}. " f"Place the GuPPy fixture set under {GUPPY_DATA_PATH}."
        )
    ...
    def interface(self, case):
        ...
        return GuppyFiberPhotometryInterface(**kwargs)
