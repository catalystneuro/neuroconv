...
class TestAddElectrodes(TestCase):
    ...
    def test_missing_int_values(self):
        ...
        recording1 = recording1.set_property(key="complete_int_property", values=[1, 2])
        add_electrodes(recording=recording1, nwbfile=self.nwbfile)
        ...
        null_value_dict = {"complete_int_property": -1, "incomplete_int_property": -3}
        add_electrodes(recording=recording2, nwbfile=self.nwbfile, null_value_dict=null_value_dict)
    ...
    def test_missing_bool_values(self):
        recording1 = generate_recording(num_channels=2)
        recording1 = recording1.rename_channels(new_channel_ids=["a", "b"])
        recording1 = recording1.set_property(key="complete_bool_property", values=[True, False])
        add_electrodes(recording=recording1, nwbfile=self.nwbfile)
        ...
        null_value_dict = {"complete_bool_property": False, "incomplete_bool_property": False}
        add_electrodes(recording=recording2, nwbfile=self.nwbfile, null_value_dict=null_value_dict)
