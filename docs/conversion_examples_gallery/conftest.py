...
from tests.test_on_data.setup_paths import HDF5_PLUGIN_PATH, ECEPHY_DATA_PATH, BEHAVIOR_DATA_PATH, OPHYS_DATA_PATH, TEXT_DATA_PATH


@pytest.fixture(autouse=True)
def add_data_space(doctest_namespace, tmp_path):
    doctest_namespace["HDF5_PLUGIN_PATH"] = HDF5_PLUGIN_PATH
