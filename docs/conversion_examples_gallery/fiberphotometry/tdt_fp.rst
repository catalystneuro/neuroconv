...
.. note::
    ...
    and virus sections). The single-series format is walked through at
    :ref:`annotate_fiber_photometry_metadata` and printed with its blanks unfilled at
    :ref:`fiber_photometry_metadata_template`; in short:
