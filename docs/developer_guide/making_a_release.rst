...
6. **Post-Release: Bump Version and Update Changelog**:
   ...
   - Bump the ``# v0.10.2 (Upcoming)`` heading at the top of ``CHANGELOG.md`` to the new development version. It is the only part of the changelog written by hand; the entries below it accumulate under ``changelog_entries/``.
