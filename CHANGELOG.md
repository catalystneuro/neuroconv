...
## Features
* Added the shared machinery for the signal-encoded events interfaces, which derive events from a sampled signal. `DoricEventsInterface` and `DoricCSVEventsInterface` are the first users. [PR #1823](https://github.com/catalystneuro/neuroconv/pull/1823)
