...
* Added `DANNCEInterface` for converting DANNCE and social-DANNCE (sDANNCE) 3D pose estimation `.mat` output files to NWB format using the ndx-pose extension. A single interface handles both single-animal DANNCE output and multi-animal sDANNCE output. [PR #1710](https://github.com/catalystneuro/neuroconv/pull/1710)
* Added `DANNCEConverter`, which combines `DANNCEInterface` with one `ExternalVideoInterface` per camera (keyed by camera name via a `video_file_paths` dict). It writes each camera's video first and then links it as that camera's `source_video` in the DANNCE `MultiCameraPoseEstimation` container. [PR #1710](https://github.com/catalystneuro/neuroconv/pull/1710)
...
* Added `metadata_key` support to imaging interfaces (`BaseImagingExtractorInterface`, `TiffImagingInterface`, `Hdf5ImagingInterface`, `SbxImagingInterface`, `MicroManagerTiffImagingInterface`, `InscopixImagingInterface`, `ThorImagingInterface`, `FemtonicsImagingInterface`, `ScanImageImagingInterface`, `ScanImageLegacyImagingInterface`, `MiniscopeImagingInterface`) and `use_new_metadata_format` parameter to `get_metadata()` for dict-based metadata pipeline. [PR #1694](https://github.com/catalystneuro/neuroconv/pull/1694), [PR #1702](https://github.com/catalystneuro/neuroconv/pull/1702), [PR #1703](https://github.com/catalystneuro/neuroconv/pull/1703), [PR #1704](https://github.com/catalystneuro/neuroconv/pull/1704), [PR #1705](https://github.com/catalystneuro/neuroconv/pull/1705), [PR #1721](https://github.com/catalystneuro/neuroconv/pull/1721), [PR #1723](https://github.com/catalystneuro/neuroconv/pull/1723)
