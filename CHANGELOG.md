...
* `CSVFiberPhotometryInterface`'s column `demux_config` now accepts a list of values for `value`, selecting the rows whose label column matches any of them (for label values that denote the same channel). [PR #1756](https://github.com/catalystneuro/neuroconv/pull/1756)
