...
* Avoid throwing validation errors when the signature of an interface does not annotate parameters [#1157](https://github.com/catalystneuro/neuroconv/pull/1157)
