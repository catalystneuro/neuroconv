...
## Improvements
* Added comprehensive FFmpeg video conversion how-to guide for converting bespoke video formats to DANDI-compatible formats [PR #XXXX](https://github.com/catalystneuro/neuroconv/pull/XXXX)
