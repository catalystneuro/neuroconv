...
* Added `CiceroneSessionInterface` for converting MonkeyCicerone v1.0 stereotaxic recording sessions to NWB, joining a Cicerone configuration file with a sites file to produce per-recording-site stereotaxic coordinates and annotations. [PR #1737](https://github.com/catalystneuro/neuroconv/pull/1737)
