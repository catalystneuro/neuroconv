...
* Migrated `TDTFiberPhotometryInterface` to a single-series interface that selects input streams via the new `stream_names` argument. Constructing without `stream_names` is deprecated and will be removed on or after August 2026. [PR #1778](https://github.com/catalystneuro/neuroconv/pull/1778)
