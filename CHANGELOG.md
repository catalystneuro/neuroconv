...
## Testing
* Added tests for `OnePhotonSeries`, `processing/ophys` container, and non-iterative write to `TestAddImaging` (dict-based metadata pipeline). [PR #TBD](https://github.com/catalystneuro/neuroconv/pull/TBD)
