...
* `read_medpc_file` and `get_medpc_variables` in `neuroconv.datainterfaces.behavior.medpc.medpc_helpers` are now private, since neither was exported or documented and both are internals of the MedPC interfaces. [PR #1944](https://github.com/catalystneuro/neuroconv/pull/1944)
