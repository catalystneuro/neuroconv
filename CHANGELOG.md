...
## Features
* Added `BaseFiberPhotometryInterface.get_example_metadata()`, which returns a complete, realistic fiber photometry metadata template — device models, devices, an indicator, and a two-row `FiberPhotometryTable` (calcium signal + isosbestic control) — to copy and edit into a full annotation. [PR #1800](https://github.com/catalystneuro/neuroconv/pull/1800)
