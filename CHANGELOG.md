...
* Renamed the container-selection parameter `write_as` to `parent_container`. The old `write_as` keyword still works but emits a `FutureWarning` and will be removed on or after December 2026. [PR #1760](https://github.com/catalystneuro/neuroconv/pull/1760)
