...
## Features
* Added `CSVEventsInterface` for converting discrete events (TTLs) stored as single-column `timestamps` CSV files into `ndx_events.Events` objects. Install with `pip install "neuroconv[csv_events]"`. [PR #1755](https://github.com/catalystneuro/neuroconv/pull/1755)
