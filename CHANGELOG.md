...
## Features
* Added HERD strain annotation. `Subject.strain` is annotated with a machine-readable RRID (Research Resource Identifier) reference stored in-file under `/general/external_resources`. [PR #XXXX](https://github.com/catalystneuro/neuroconv/pull/XXXX)
