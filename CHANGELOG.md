...
* Added `metadata_key` support to segmentation interfaces (`BaseSegmentationExtractorInterface`, `CaimanSegmentationInterface`, `CnmfeSegmentationInterface`, `ExtractSegmentationInterface`, `SimaSegmentationInterface`, `InscopixSegmentationInterface`) and `use_new_metadata_format` parameter to `get_metadata()` for dict-based metadata pipeline. [PR #1708](https://github.com/catalystneuro/neuroconv/pull/1708), [PR #1722](https://github.com/catalystneuro/neuroconv/pull/1722)
