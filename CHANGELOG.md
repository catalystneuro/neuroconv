...
* Added `metadata_key` support to imaging interfaces (`BaseImagingExtractorInterface`, `TiffImagingInterface`, `Hdf5ImagingInterface`, `SbxImagingInterface`, `MicroManagerTiffImagingInterface`, `InscopixImagingInterface`) and `use_new_metadata_format` parameter to `get_metadata()` for dict-based metadata pipeline. [PR #1694](https://github.com/catalystneuro/neuroconv/pull/1694), [PR #1702](https://github.com/catalystneuro/neuroconv/pull/1702), [PR #1703](https://github.com/catalystneuro/neuroconv/pull/1703)
