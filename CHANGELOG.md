...
* Introduced `null_values_for_properties` to `add_units_table` to give user control over null values behavior [PR #984](https://github.com/catalystneuro/neuroconv/pull/984)
...
* Removed a bug where int64 was casted lossy to float [PR #984](https://github.com/catalystneuro/neuroconv/pull/984)
