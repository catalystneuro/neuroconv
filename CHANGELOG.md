...
* Deprecated `BrukerTiffSinglePlaneImagingInterface`, `BrukerTiffMultiPlaneImagingInterface`, `BrukerTiffSinglePlaneConverter`, and `BrukerTiffMultiPlaneConverter`. Use the unified `BrukerTiffImagingInterface` (or `BrukerTiffConverter` for multi-channel and multi-plane folders) instead. Will be removed on or after December 2026. [PR #1773](https://github.com/catalystneuro/neuroconv/pull/1773)
