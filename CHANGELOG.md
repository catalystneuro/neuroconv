...
## Features
* Added `CSVFiberPhotometryInterface` for converting raw fiber photometry recordings from CSV file(s), parsed into the `ndx-fiber-photometry` format.  [PR #1754](https://github.com/catalystneuro/neuroconv/pull/1754)
