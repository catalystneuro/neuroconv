...
class NWBConverter:
    ...
    def add_to_nwbfile(self, nwbfile: NWBFile, metadata, conversion_options: Optional[dict] = None) -> NWBFile:
        """
        ...
        -------
        nwbfile : NWBFile
            The NWB file object with the data from the data interfaces added to it.
        """
