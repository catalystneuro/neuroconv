...
def write_waveforms(
    ...
    raise NotImplementedError(
        "This function is deprecated since the WaveformExtractor object has "
        "been discontinued since SpikeInterface version 0.101.0. "
        "Use write_sorting_analyzer instead."
    )
