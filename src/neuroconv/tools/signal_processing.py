...
# NOTE: copied from the Intan digital PR (#1812) to unify the Inscopix events edge-detection with it;
# de-duplicate when that PR merges (both add this same function to this module).
