...
- **inference** -- ``infer_species_ontology_metadata`` / ``infer_strain_ontology_metadata`` /
  ...
  free-text values to ontology terms and write those terms into ``metadata`` next to the value they
  describe. This step guesses; run it when you want NeuroConv to propose terms.
