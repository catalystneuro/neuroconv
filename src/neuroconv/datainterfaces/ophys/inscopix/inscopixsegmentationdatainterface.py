...
class InscopixSegmentationInterface(BaseSegmentationExtractorInterface):
    ...
    def get_metadata(self) -> dict:
        ...
        self._populate_imaging_plane_metadata(imaging_plane_metadata, imaging_info, session_info, device_info)
    ...
    def _populate_imaging_plane_metadata(
        self, imaging_plane_metadata: dict, imaging_info: dict, session_info: dict, device_info: dict
    ):
