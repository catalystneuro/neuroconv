...
Methodology for digital extraction and ttl event parsing is ported from
# https://github.com/SpikeInterface/spikeextractors/tree/d24335cc2fa6e407469b790dc8fea2fdadb2b2a3/spikeextractors/extractors/spikeglxrecordingextractor
...
def makeMemMapRaw(binFullPath, meta):
    ...
    rawData = np.memmap(binFullPath, dtype="int16", mode="r", shape=(nChan, nFileSamp), offset=0, order="F")
    return rawData
