...
def write_units(
    ...
    assert write_as in ["units", "processing"], (
    ...
    units_table = pynwb.misc.Units(
        name=metadata.get("UnitProperties", dict()).get(key="units_name", default="units"),
        description=metadata.get("UnitProperties", dict()).get(
            key="units_description",
            default="Autogenerated by nwb-conversion-tools."
        ),
    )
